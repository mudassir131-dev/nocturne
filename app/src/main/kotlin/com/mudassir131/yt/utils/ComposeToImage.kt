...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: com.mudassir131.yt.ui.component.LyricsGlassStyle? = null
    ): Bitmap = withContext(Dispatchers.Default) {
        val style = glassStyle ?: com.mudassir131.yt.ui.component.LyricsGlassStyle.FrostedDark
    ...
    private fun AppLogo(
        ...
        val rawLogo = context.getDrawable(R.drawable.ic_nocturne_logo_dark_trans)?.toBitmap(logoSize, logoSize)
    ...
    suspend fun createShareCard(
        ...
        val rawLogo = context.getDrawable(R.drawable.ic_nocturne_logo_dark_trans)?.toBitmap(logoSize.toInt(), logoSize.toInt())
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Nocturne")
            }
