...
package com.mudassir131.yt.together
...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.mudassir131.yt.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.mudassir131.yt.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.mudassir131.yt.together.JoinDecision -> {
