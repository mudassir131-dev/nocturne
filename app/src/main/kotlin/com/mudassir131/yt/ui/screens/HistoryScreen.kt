...
import com.mudassir131.yt.constants.HistorySource
...
import com.mudassir131.yt.viewmodels.DateAgo
import com.mudassir131.yt.viewmodels.HistoryViewModel
                ...
                Column(Modifier.fillMaxWidth()) {
                    ...
                    ChipsRow(
                        ...
                        onValueUpdate = {
                            ...
                            if (it == HistorySource.REMOTE) viewModel.fetchRemoteHistory()
                        },
                    )
                }
            },
            ...
            if (historySource == HistorySource.REMOTE && isLoggedIn) {
                filteredRemoteContent?.forEach { section ->
                    ...
                    itemsIndexed(
                        ...
                        androidx.compose.runtime.CompositionLocalProvider(
                            com.mudassir131.yt.ui.utils.LocalListItemShape provides com.mudassir131.yt.ui.utils.getGroupShape(index, section.songs.size)
                        ) {
                            YouTubeListItem(
                                item = song,
                ...
                filteredEvents.forEach { (dateAgo, events) ->
                    ...
                    itemsIndexed(
                        ...
                        androidx.compose.runtime.CompositionLocalProvider(
                            com.mudassir131.yt.ui.utils.LocalListItemShape provides com.mudassir131.yt.ui.utils.getGroupShape(index, currentDateWrappedItems.size)
                        ) {
                            SongListItem(
                                song = event.song,
