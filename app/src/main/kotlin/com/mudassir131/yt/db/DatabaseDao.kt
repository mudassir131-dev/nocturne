...
import com.mudassir131.yt.db.entities.AlbumArtistMap
import com.mudassir131.yt.db.entities.AlbumEntity
import com.mudassir131.yt.db.entities.PlayCountEntity
import com.mudassir131.yt.db.entities.AlbumWithSongs
...
import com.mudassir131.yt.db.entities.EventWithSong
...
import com.mudassir131.yt.db.entities.SetVideoIdEntity
import com.mudassir131.yt.db.entities.Song
import com.mudassir131.yt.db.entities.SongAlbumMap
...
interface DatabaseDao {
    ...
    fun getAllSkips(): Flow<List<com.mudassir131.yt.db.entities.SongSkipEntity>>

    @Query("SELECT * FROM song_skip WHERE songId = :songId LIMIT 1")
    suspend fun getSkip(songId: String): com.mudassir131.yt.db.entities.SongSkipEntity?

    @Upsert
    suspend fun upsertSkip(skip: com.mudassir131.yt.db.entities.SongSkipEntity)
