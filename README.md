...
| APK | Recommended for |
| --- | --- |
| `Nocturne-V2.22.03.19-arm64-v8a-release.apk` | Most modern Android phones and tablets. Smaller download. |
| `Nocturne-V2.22.03.19-universal-release.apk` | Unknown CPU architecture or broader compatibility. |
...
```powershell
Get-FileHash .\Nocturne-V2.22.03.19-universal-release.apk -Algorithm SHA256
```

```bash
sha256sum Nocturne-V2.22.03.19-universal-release.apk
```
